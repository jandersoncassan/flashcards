...
import static br.com.dio.reactive.flashcard.domain.exception.BaseErrorMessage.GENERIC_EXCEPTION;
...
public class GenericHandler extends AbstractHandleException<Exception>{
    ...
    public Mono<Void> handlerException(final ServerWebExchange exchange, final Exception ex) {
        return Mono.fromCallable(() -> {
                ...
                }).map(message -> buildError(INTERNAL_SERVER_ERROR, message, exchange))
